  ...
  return (
    <div class="lws-task">
      ...
      <div class="lws-taskContainer">
        ...
        <span class="lws-task-badge color-scoreboard">{projectName}</span>
      </div>

      <div class="flex items-center gap-4">
        <div class="flex items-center gap-2">
          <img src={avatar} class="team-avater" alt='..' />
        ...
        {/* <!-- delete button will not shown to the ui, until the status of the task will be completed --> */}
        {
          status === 'complete' ?
            ...
            <>
              <Link to={`/tasks/edit/${taskId}`}><button class="lws-edit">
        ...
        <select defaultValue={status} class="lws-status" onChange={handleStatusChange}>
